  ...
  RSpec.describe RoomsController, type: :controller do
    before(:each) do
     ...
     # Session.delete_all # required?
      p "Seeding for test"
      p "Adding users: 1..3"
      @user1 = User.create(name: "User1Admin", email: "cayala.w+testadmin@gmail.com", password: "123456", role: "admin") # admin
      @user2 = User.create(name: "User2Regular", email: "cayala.w+testuser1@gmail.com", password: "123456") # user      
    ...
    describe "Delete booking" do
      it "Delete booking and check existance" do
